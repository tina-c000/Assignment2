...
Considering the data obtain, no improvement seems to be done in order to reduce bycatching, which is mantained constant.
...
ggplot(data = combine_stats, aes(x =Year, y = Mean, fill= Taxa)) +
  ...
  geom_point(size=0.7)+
  xlab("Year") + ylab("Mean of species caught")
